...
$mysqli=xconectar($_SESSION['UsuariaSV'],descriptSV($_SESSION['PassSV']),$_SESSION['BaseSV']);	
	...
	$FECHA=date("Y/m/d"); 
	mysql_query("INSERT INTO CTCorreoReg VALUES('','$FECHA','$email','A')");
	
	$SQL="SELECT * FROM CTParametros WHERE tipo='CORR_PRIN'";
	$resultados = $mysqli->query($SQL);
	while ($registro = $resultados->fetch_assoc()) {
		$Corr_prin=$registro["valor"];
	}
...
$para = $Corr_prin;//Email al que se enviará
...
<tr>
<td width='30%' align='left' bgcolor='#f0efef'><strong>Tel&eacute;fono:</strong></td>
...
<!--<tr>
<td width='30%' align='left' bgcolor='#f0efef'><strong>Pa&iacute;s:</strong></td>
