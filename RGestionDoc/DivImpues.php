<?php
	...
	if ($_POST['SwInsert']==1 && $_POST['SelCtaDiv']>0 && $_POST['MontDiv']>0) {
		if (!isset($_SESSION['CARRITOImp'])) {
			$productos=array(
				'SelCtaDiv'=>$_POST['SelCtaDiv'],
				'SelCCDiv'=>$_POST['SelCCDiv'],
				'MontDiv'=>$_POST['MontDiv']
			);
			$_SESSION['CARRITOImp'][0]=$productos;
		}else{
			// $IdProducto=array_column($_SESSION['CARRITOImp'],"SelCtaDiv");
			// $mens="";

			// $CCProducto=array_column($_SESSION['CARRITOImp'],"SelCCDiv");
			// $mens="";
			...
			// }else{
				$NProductos=count($_SESSION['CARRITOImp']);
				$productos=array(
					'SelCtaDiv'=>$_POST['SelCtaDiv'],
					'SelCCDiv'=>$_POST['SelCCDiv'],
					'MontDiv'=>$_POST['MontDiv']
				);
				$_SESSION['CARRITOImp'][$NProductos]=$productos;
			// }
		}
	}
	...
	if (isset($_POST['SwEliDiv']) && $_POST['SwEliDiv']!="") {
		$L=$_POST['SwEliDiv'];
		unset($_SESSION['CARRITOImp'][$L]);
		$_SESSION['CARRITOImp']=array_values($_SESSION['CARRITOImp']);
	}
	...
	if (isset($_SESSION['CARRITOImp'])) {
		...
		foreach($_SESSION['CARRITOImp'] as $indice=>$producto){
