...
<body>
	<h1>Administraci&oacute;n MasTecno</h1>
	<div class="main-agile">
		<!-- <div class="alert-close"> </div> -->
		<div class="content-wthree">
		<div class="circle-w3layouts"></div>
			<h2>Login</h2>
			<form action="xvalidar.php" method="POST">
	...
	<div class="footer-w3l">
		<p class="agileinfo"> &copy; 2018 Cpanel Basico. Todos los derechos reservados | Dise&ntilde;ado por <a href="http://www.mastecno.cl">Mastecno</a></p>
	</div>
</body>
</html>