...
<html >
	<head>
		...
		<script type="text/javascript">
			...
			function ProcesarStrFull() {
				if (form1.SqlScript.value === "") {
					alert("Inserte String Sql para continuar");
				} else {
					// Mostramos un mensaje de confirmación
					if (confirm("¿Está seguro de que desea continuar?")) {
						var url = "xsqlProcesoFull.php";
				...
				<form action="#" method="POST" name="form1" id="form1">
					...
					<div class="col-md-12">
						...
						<span class="input-group-addon">Indicadores</span>
							<input type="text" name="TxtPeriodo" id="TxtPeriodo" class="form-control" value="<?php echo date("m-Y"); ?>">
						</div>

						<button type="button" class="btn btn-default" onclick="Indica()">Indicadores</button>
					...
					<div class="col-md-12">
						<button type="button" class="btn btn-default btn-xs" id="Bt" onclick="ProcesarStrFull()" >Procesar Full</button>
