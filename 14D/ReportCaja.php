<?php
	...
	$Str=$Str.'
		...
		<table class="table-condensed table-bordered table-hover" style="width: 100%;" border="1">
			...
			<tbody>';
					...
					while ($registro = $resultados->fetch_assoc()) {
						...
						if(isset($_POST['tos']) && $_POST['tos']==='accepted' && $registro['TipDoc']!="34-FaElEx" && $registro['TipDoc']!="46-FaCoEl"){
							if ($registro['NumDoc']!="") {
								$Col2=$Col2-$registro['IVA'];
						...
						$Str=$Str.'
							<tr>
								...
								<td style="text-align: right;">'.$pf.number_format($Col1, $NDECI, $DDECI, $DMILE).$sf.'</td>
								<td style="text-align: right;" data-toggle="modal" data-target="#Autoriza" onclick="Conf('.$registro['Id'].')">'.$pf.number_format($Col2, $NDECI, $DDECI, $DMILE).$sf.'</td>
							</tr>
						';
		...
		<table class="table table-condensed table-bordered" border="1">
				...
				<tr>
					<td colspan="6" style="text-align: center;"><strong>SALDOS Y TOTALES LIBRO DE CAJA</strong></td>
				</tr> 

				<tr>
					<td colspan="3" style="text-align: center;" width="49.8%"><strong>FLUJO DE INGRESOS Y EGRESOS</strong></td>
					<td colspan="3" style="text-align: center;" width="50.2%"><strong>MONTOS QUE AFECTAN LA BASE IMPONIBLE</strong></td>
				</tr>

				<tr>
					<td style="text-align: center;" width="16.6%"><strong>TOTAL MONTO RESUMEN FLUJO DE INGRESOS DEL PER&Iacute;ODO</strong></td>
					<td style="text-align: center;" width="16.6%"><strong>TOTAL MONTO RESUMEN FLUJO DE EGRESOS DEL PER&Iacute;ODO</strong></td>
					<td style="text-align: center;" width="16.6%"><strong>SALDO FLUJO DE CAJA</strong></td>
					<td style="text-align: center;" width="16.6%"><strong>TOTAL RESUMEN DE INGRESOS</strong></td>
					<td style="text-align: center;" width="16.6%"><strong>TOTAL RESUMEN DE EGRESOS</strong></td>
					<td style="text-align: center;" width="17%"><strong>RESULTADO NETO</strong></td>
				</tr>

				<tr>
					<td style="text-align: center;">'.number_format($Ing1, $NDECI, $DDECI, $DMILE).'</td>
					<td style="text-align: center;">'.number_format($Egr1, $NDECI, $DDECI, $DMILE).'</td>
					<td style="text-align: center;">'.number_format(($Ing1-$Egr1), $NDECI, $DDECI, $DMILE).'</td>
					<td style="text-align: center;">'.number_format($Ing2, $NDECI, $DDECI, $DMILE).'</td>
					<td style="text-align: center;">'.number_format($Egr2, $NDECI, $DDECI, $DMILE).'</td>
					<td style="text-align: center;">'.number_format(($Ing2-$Egr2), $NDECI, $DDECI, $DMILE).'</td>
				</tr>
			</tbody>
		</table>
	';
	...
	if ($_SERVER["REQUEST_URI"]=="/14D/ReportPDF.php") {
		...
		if ($_SERVER["REQUEST_URI"]=="/14D/ReportXLS.php") {
