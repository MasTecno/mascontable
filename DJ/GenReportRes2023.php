			...
			<tbody>
				...
				<?php 
					...
					while ($registro = $resultados->fetch_assoc()) {
						...
						echo '
								<td width="111" class="text-right">0</td>
								<td width="111" class="text-right">'.number_format($Up3, $NDECI, $DDECI, $DMILE).'</td>
								<td width="82" class="text-center">'.$registro['certificado'].'</td>
							</tr>
						';
						$SumRetTotal=$SumRetTotal+$tretec;
						$SumRetPrest=$SumRetPrest+$Up3;
			...
			<div class="col-md-10">
					<table class="table table-bordered">
					  ...
					  <tr>
					    ...
					    <td class="text-right" colspan="2">0</td>
					    <td class="text-right" colspan="2">0</td>
					    <td class="text-right" colspan="2"><?php echo number_format($SumRetPrest, $NDECI, $DDECI, $DMILE); ?></td>
