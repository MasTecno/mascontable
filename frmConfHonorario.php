...
<html >
	...
	<div class="row content">
		...
		<form action="xfrmConfHonorario.php" method="POST" name="form1" id="form1">
			...
			<div class="col-sm-8">            
				<h3>Centralizaci&oacute;n de Hororario Recibido</h3> 
					...
					<div class="col-md-2">
						...
						<div class="input-group"> 
							<input type="text" class="form-control text-right" id="Comp4" name="Comp4" required maxlength="50" value="<?php echo $XC4; ?>">
							<div class="input-group-btn"> 
					...
					<div class="col-md-10">
						<label>Detalle</label>  
						<input type="text" class="form-control" id="DComp1" name="DComp1" onChange="javascript:this.value=this.value.toUpperCase();" value="<?php echo strtoupper($XnC1); ?>, * Total Documento"  readonly="false" >
						<input type="text" class="form-control" id="DComp2" name="DComp2" onChange="javascript:this.value=this.value.toUpperCase();" value="<?php echo strtoupper($XnC2); ?>, Retenci&oacute;n"  readonly="false" >
						<input type="text" class="form-control" id="DComp3" name="DComp3" onChange="javascript:this.value=this.value.toUpperCase();" value="<?php echo strtoupper($XnC3); ?>, Total Liquido x Pagar"  readonly="false" >
						<input type="text" class="form-control" id="DComp4" name="DComp4" onChange="javascript:this.value=this.value.toUpperCase();" value="<?php echo strtoupper($XnC4); ?>, 3% Retenci&oacute;n"  readonly="false" >
					</div>
