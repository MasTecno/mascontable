<?php
	...
	while ($registro = $resultado->fetch_assoc()) {
		...
		if (isset($_POST['anual']) && $_POST['anual']=="1") { 
			...
			$sqlverifica="SELECT * FROM CTRegLibroDiario WHERE rutempresa='$RutEmpresa' AND periodo like '%-$AnoConsul' AND estado='A' AND glosa='' AND cuenta='".$registro["numero"]."'";
		}else{
			$sqlverifica="SELECT * FROM CTRegLibroDiario WHERE rutempresa='$RutEmpresa' AND periodo ='".$PerConsulta."' AND estado='A' AND glosa='' AND cuenta='".$registro['numero']."'";
		}
