		...
		<form action="xfrmAsientoBolEle.php" method="POST" name="form1" id="form1">
				...
				<div class="flex justify-start items-center px-6 pt-3 pb-3 bg-gray-100 w-full shadow">
					...
					<div>
						<h3 class="text-lg font-semibold text-gray-800">
							Centralizaci&oacute;n Boletas Electronicas
						</h3>
			...
			<div class="bg-white rounded-lg shadow-sm border border-gray-200 mt-5">
				...
				<div class="p-6 pt-1 space-y-6">
					...
					<div>
						<label for="Comp4">Cuenta</label>
						<div class="flex items-center gap-2"> 
							<input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" id="Comp4" name="Comp4" required maxlength="50" value="<?php echo $XPago; ?>">
					...
					<div>
						<label for="DComp4">Detalle</label>  
						<input type="text" class="w-full bg-gray-100 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" id="DComp4" name="DComp4" onChange="javascript:this.value=this.value.toUpperCase();" value="<?php echo strtoupper($XnPago); ?>"  readonly="false" >
					</div>
