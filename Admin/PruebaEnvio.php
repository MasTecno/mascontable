...
<!-- End of HubSpot Embed Code -->
	...
	$destino = "samcom.cl@gmail.com"; // correo del destino 
...
//	$mail->Is(); //le decimos a la clase que utilice SMTP
	...
	try {
		...
		$mail->Subject = "Factura MasTecno XXX"; // titulo del email
...
exit;
	...
	$mysqli->query("INSERT INTO FacturasMastecno VALUES('','".$_POST['ListServ']."','$xServer','11-2019','2019-11-05','$CodigoDoc','$NumDoc','$NomDoc','0000-00-00','0000-00-00','".$_POST['TMonto']."','A')");

	$mysqli->query("INSERT INTO LogEnvio VALUES('','$xServer','11-2019','".date("Y-m-d")."','A')");
