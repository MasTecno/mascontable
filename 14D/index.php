						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title">Instrucciones de Uso para la Generación de 14D</h4>
								</div>
								<div class="modal-body" style="font-size: 14px;">
										La generación de reporte en el sistema requiere cumplir con las siguientes condiciones:<br><br>

										1.	<strong>Configuración de Cuentas con Control de Ingreso</strong><br>
										&nbsp;&nbsp;•	Requisito: Asegúrese de tener configuradas una o más cuentas con Control de Ingreso en el mantenedor de cuentas.<br>
										Ejemplo de cuentas válidas:<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;»	Caja <br><br>

										2.	<strong>Identificación del Asiento de Apertura del Período</strong><br>
										&nbsp;&nbsp;•	Paso a seguir:<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;»	Identifique el Voucher correspondiente al asiento de apertura del período. En las opciones del Voucher, seleccione la opción: Marcar como Apertura.<br> 
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;» Esto no corresponde al base imponible, ya que es un saldo solo afecta solo al flujo de ingreso y egreso.<br>



										3.	<strong>Centralización de Documentos</strong><br>
										&nbsp;&nbsp;•	Requisito: Todos los documentos deben ser centralizados a través del auxiliar correspondiente:<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;»	Clientes, Proveedores u Honorarios.<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;»	Estos generan un asiento de tipo Traspaso, permitiendo que el sistema identifique si se trata de un documento por pagar o por cobrar.<br>
										&nbsp;&nbsp;•	Reglas adicionales:<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;»	En caso de realizar un pago directo o usar el generador de pagos, se generará un Voucher de tipo Ingreso o Egreso.<br>
										&nbsp;&nbsp;•	Este debe afectar:<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;»	La cuenta del auxiliar correspondiente. Contra las cuentas de Control de Ingreso mencionadas en el punto 1.<br><br>

										4.	<strong>Identificación de Vouchers que No Afecten la Base Imponible</strong><br>
										&nbsp;&nbsp;•	Ejemplo: Pagos como el PPM (Pago Provisional Mensual).<br>
										&nbsp;&nbsp;•	Procedimiento: En las opciones del Voucher, seleccione la opción: No afecta base imponible.<br><br>

										<strong>Nota Importante:</strong>
										Asegúrese de revisar cada paso para evitar errores en la configuración y procesamiento de los reportes.<br>
