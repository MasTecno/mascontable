<?php
    ...
    if (isset($_POST['Membre']) && $_POST['Membre']!="N") {
        if (strlen($xRUT)==9) {
    ...
    if (isset($_POST['Membre']) && $_POST['Membre']=="S") {
        if (strlen($xRrep)==9) {
    ...
    // Genera el PDF
    $pdf->Output('Foliador_'.$_SESSION['RUTEMPRESA'].'.pdf', 'I');
?>