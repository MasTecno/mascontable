<?php
    ...
    if (isset($_POST['ConMem'])) {
        ...
        $TMembrete = $TMembrete."Ciudad: ".$xCUI."<br>";
...
// exit;
    ...
    // 'L'=horizontal
    // 'P'=vertical
    $pdf = new MYPDF($_POST['PageOri'], PDF_UNIT, 'LETTER', true, 'UTF-8', false, false, $TFOLIO, $CFOLIO, $Folio, $TMembrete);
