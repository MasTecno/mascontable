						...
						<div class="flex flex-wrap justify-start items-center gap-2 border-2 border-gray-300 rounded-md p-2">
							...
							?>
									...
									<?php if ($_SESSION['ROL']=="A") { ?>
										<button type="button" id="btnEliminar" onclick="EliminarContador()" class="bg-gray-100 hover:bg-gray-300 text-sm text-black font-medium py-1 px-2 border-2 border-gray-600 rounded-md transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2" tabindex="16">
