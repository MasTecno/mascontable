<?php
    if($_POST['name']!=""){
        ...
        $sql = "SELECT * FROM Facturas WHERE Fecha BETWEEN '2023-01-01' AND ? AND (Rut = ? ".$Cadera.") ORDER BY Fecha ASC";
                    ...
                    <div class="card-body p-5">
                        ...
                        <form id="recoveryForm" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" required placeholder="Ingrese el servidor">
